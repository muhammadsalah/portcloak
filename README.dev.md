...
# PortCloak — building and contributing

> This is the developer's README: how PortCloak is built, tested, released and signed, and where
> the design record lives. If you want to **use** the tool, [`README.md`](./README.md) describes
